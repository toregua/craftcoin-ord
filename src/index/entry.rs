...
impl CuneEntry {
  pub(crate) fn spaced_cune(&self) -> SpacedCune {
    SpacedCune {
      cune: self.cune,
...
impl Entry for CuneEntry {
  type Value = CuneEntryValue;
  fn load(
    (
      block,
      burned,
...
pub(super) type CuneIdValue = (u64, u32);

impl Entry for CuneId {
  type Value = CuneIdValue;
...
pub(super) type CuneAddressBalance = (u128, u128);
